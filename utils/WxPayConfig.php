...
class WxPayConfig extends WxPayConfigInterface
{
    ...
    {
        return Yii::$app->params['WeChatParams']['appid'];
    }

    public function GetMerchantId()
    {
        return Yii::$app->params['WeChatParams']['mch_id'];
    }
    ...
    {
        return Yii::$app->params['WeChatParams']['notify_url'];
    }

    public function GetSignType()
    {
        return Yii::$app->params['WeChatParams']['sign_type'];
    }
    ...
    {
        return Yii::$app->params['WeChatParams']['key'];
    }

    public function GetAppSecret()
    {
        return Yii::$app->params['WeChatParams']['app_secret'];
    }
